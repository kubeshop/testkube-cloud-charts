...
![Version: 14.6.16](https://img.shields.io/badge/Version-14.6.16-informational?style=flat-square) ![AppVersion: 2024.6.29](https://img.shields.io/badge/AppVersion-2024.6.29-informational?style=flat-square)
...
| clientImage.tag | string | `"2024.6.24-debian-12-r1"` |  |
...
| image.tag | string | `"2024.6.29-debian-12-r0"` |  |
