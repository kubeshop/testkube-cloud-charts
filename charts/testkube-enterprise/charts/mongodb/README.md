...
| arbiter.podSecurityContext.supplementalGroups | list | `[]` |  |
...
| externalAccess.autoDiscovery.image.tag | string | `"1.31.2-debian-12-r3"` |  |
...
| hidden.containerSecurityContext.readOnlyRootFilesystem | bool | `true` |  |
