...
![Version: 1.41.5](https://img.shields.io/badge/Version-1.41.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.29.5 |
...
| testkube-cloud-api.image.tag | string | `"1.7.4"` |  |
