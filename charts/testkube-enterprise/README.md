...
![Version: 2.319.10](https://img.shields.io/badge/Version-2.319.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.20.2 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.176.2 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.116.2 |
| file://../testkube-worker-service | testkube-worker-service | 1.79.3 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.243 |
...
| testkube-ai-service.image.tag | string | `"1.15.1"` |  |
...
| testkube-cloud-api.image.tag | string | `"1.15.1"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.15.1"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.15.1"` |  |
...
| testkube-worker-service.image.tag | string | `"1.15.1"` |  |
