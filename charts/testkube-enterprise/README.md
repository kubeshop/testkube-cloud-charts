...
![Version: 1.74.2](https://img.shields.io/badge/Version-1.74.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.34.1 |
...
| testkube-cloud-ui.image.tag | string | `"1.9.9"` |  |
