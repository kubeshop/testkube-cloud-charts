...
![Version: 2.316.0](https://img.shields.io/badge/Version-2.316.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-api | testkube-cloud-api | 1.174.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.115.0 |
...
| testkube-ai-service.image.tag | string | `"1.13.0"` |  |
...
| testkube-cloud-api.image.tag | string | `"1.13.0"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.13.0"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.13.0"` |  |
...
| testkube-worker-service.image.tag | string | `"1.13.0"` |  |
