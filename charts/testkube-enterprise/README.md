...
![Version: 2.100.0](https://img.shields.io/badge/Version-2.100.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.135.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.91.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.50.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.115 |
...
| testkube-cloud-api.image.tag | string | `"1.11.4"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.11.4"` |  |
...
| testkube-worker-service.image.tag | string | `"1.11.4"` |  |
