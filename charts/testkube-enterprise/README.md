...
![Version: 2.254.1](https://img.shields.io/badge/Version-2.254.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.8.1 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.164.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.106.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.71.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.207 |
...
| testkube-cloud-api.image.tag | string | `"1.11.24"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.11.24"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.11.1"` |  |
...
| testkube-worker-service.image.tag | string | `"1.11.24"` |  |
