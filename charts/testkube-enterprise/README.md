...
![Version: 1.12.40](https://img.shields.io/badge/Version-1.12.40-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| testkube-cloud-api.image.tag | string | `"1.4.0-dev-0bd1f1d"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.4.0-dev-1b62f33"` |  |
