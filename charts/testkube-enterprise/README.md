...
![Version: 2.22.1](https://img.shields.io/badge/Version-2.22.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.106.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.83 |
...
| testkube-cloud-api.image.tag | string | `"1.10.80"` |  |
