...
![Version: 2.50.1](https://img.shields.io/badge/Version-2.50.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.115.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.79.1 |
...
| testkube-cloud-api.image.tag | string | `"1.10.86"` |  |
