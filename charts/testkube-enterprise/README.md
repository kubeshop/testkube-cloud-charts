...
![Version: 1.118.1](https://img.shields.io/badge/Version-1.118.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.64.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.54.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.0.4 |
...
| testkube-cloud-api.image.tag | string | `"1.10.29"` |  |
