...
![Version: 1.56.11](https://img.shields.io/badge/Version-1.56.11-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.36.4 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.29.16 |
...
| testkube-cloud-api.image.tag | string | `"1.10.1"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.8.12"` |  |
