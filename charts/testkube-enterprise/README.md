...
![Version: 1.105.2](https://img.shields.io/badge/Version-1.105.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.59.2 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.48.0 |
...
| testkube-cloud-api.image.tag | string | `"1.10.19"` |  |
