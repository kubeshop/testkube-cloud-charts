...
![Version: 1.58.2](https://img.shields.io/badge/Version-1.58.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.38.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.29.20 |
...
| testkube-cloud-api.image.tag | string | `"1.10.3"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.8.16"` |  |
