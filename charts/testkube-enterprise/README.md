...
![Version: 1.174.0](https://img.shields.io/badge/Version-1.174.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.91.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.65.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.52 |
...
| testkube-cloud-api.image.tag | string | `"1.10.64"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.6.1"` |  |
