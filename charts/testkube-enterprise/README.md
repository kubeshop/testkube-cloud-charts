...
![Version: 1.56.2](https://img.shields.io/badge/Version-1.56.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.36.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.29.11 |
...
| testkube-cloud-ui.image.tag | string | `"1.8.6"` |  |
