...
![Version: 2.159.0](https://img.shields.io/badge/Version-2.159.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.0.5 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.147.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.101.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.57.0 |
| file://./charts/dex | dex | 0.19.1-7 |
| file://./charts/minio | minio | 14.8.3-2 |
| file://./charts/mongodb | mongodb | 16.2.1-1 |
| file://./charts/nats | nats | 1.2.6-4 |
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.149 |
...
| testkube-cloud-api.image.tag | string | `"1.11.11"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.11.11"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.10.2"` |  |
...
| testkube-worker-service.image.tag | string | `"1.11.11"` |  |
