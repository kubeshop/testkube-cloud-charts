...
![Version: 2.30.1](https://img.shields.io/badge/Version-2.30.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.109.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.78.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.87 |
...
| testkube-cloud-api.image.tag | string | `"1.10.82"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.7.4"` |  |
