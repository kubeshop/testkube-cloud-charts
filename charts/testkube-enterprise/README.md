...
![Version: 1.137.4](https://img.shields.io/badge/Version-1.137.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.75.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.0.28 |
...
| testkube-cloud-api.image.tag | string | `"1.10.43"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.1.0"` |  |
