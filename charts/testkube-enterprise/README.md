...
![Version: 1.56.7](https://img.shields.io/badge/Version-1.56.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.36.2 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.29.14 |
...
| testkube-cloud-api.image.tag | string | `"1.9.23"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.8.10"` |  |
