...
![Version: 1.140.5](https://img.shields.io/badge/Version-1.140.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.77.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.58.3 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.2 |
...
| testkube-cloud-api.image.tag | string | `"1.10.48"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.2.0"` |  |
