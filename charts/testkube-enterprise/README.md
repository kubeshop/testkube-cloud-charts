...
![Version: 2.143.0](https://img.shields.io/badge/Version-2.143.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.0.2 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.144.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.99.0 |
...
| testkube-cloud-ui.image.tag | string | `"2.10.0"` |  |
