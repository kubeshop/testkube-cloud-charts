...
![Version: 1.149.2](https://img.shields.io/badge/Version-1.149.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.80.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.12 |
...
| testkube-cloud-api.image.tag | string | `"1.10.52"` |  |
