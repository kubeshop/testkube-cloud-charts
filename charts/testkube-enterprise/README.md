...
![Version: 2.195.1](https://img.shields.io/badge/Version-2.195.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-api | testkube-cloud-api | 1.153.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.103.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.60.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.167 |
...
| testkube-cloud-api.image.tag | string | `"1.11.16"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.11.16"` |  |
...
| testkube-worker-service.image.tag | string | `"1.11.16"` |  |
