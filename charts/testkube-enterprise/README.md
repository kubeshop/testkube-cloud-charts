...
![Version: 2.305.0](https://img.shields.io/badge/Version-2.305.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.17.0 |
...
| testkube-ai-service.image.tag | string | `"2.4.1"` |  |
