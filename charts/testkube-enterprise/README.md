...
![Version: 1.43.3](https://img.shields.io/badge/Version-1.43.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.24.2 |
...
| testkube-cloud-ui.image.tag | string | `"1.7.5"` |  |
