...
![Version: 2.150.1](https://img.shields.io/badge/Version-2.150.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.0.4 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.145.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.100.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.144 |
...
| testkube-cloud-ui.image.tag | string | `"2.10.1"` |  |
