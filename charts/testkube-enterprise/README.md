...
![Version: 2.90.0](https://img.shields.io/badge/Version-2.90.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.132.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.88.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.112 |
...
| testkube-cloud-api.image.tag | string | `"1.10.95"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.8.1"` |  |
