...
![Version: 1.181.1](https://img.shields.io/badge/Version-1.181.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.93.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.57 |
...
| testkube-cloud-api.image.tag | string | `"1.10.67"` |  |
