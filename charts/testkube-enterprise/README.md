...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.8.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.8.3 |
...
| testkube-cloud-api.image.tag | string | `"1.2.0-dev-60eec64"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.2.0-dev-cdd12a7"` |  |
