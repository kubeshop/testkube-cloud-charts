...
![Version: 2.274.0](https://img.shields.io/badge/Version-2.274.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-api | testkube-cloud-api | 1.167.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.106.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.73.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.216 |
...
| testkube-cloud-api.image.tag | string | `"1.11.26"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.11.26"` |  |
...
| testkube-worker-service.image.tag | string | `"1.11.26"` |  |
