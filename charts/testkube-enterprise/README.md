...
![Version: 1.151.10](https://img.shields.io/badge/Version-1.151.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.81.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.28 |
...
| testkube-cloud-api.image.tag | string | `"1.10.55"` |  |
