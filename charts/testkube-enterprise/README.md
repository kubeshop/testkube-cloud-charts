...
![Version: 2.139.1](https://img.shields.io/badge/Version-2.139.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.0.1 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.143.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.98.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.55.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.139 |
