...
![Version: 2.319.27](https://img.shields.io/badge/Version-2.319.27-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.20.3 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.176.3 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.116.3 |
| file://../testkube-worker-service | testkube-worker-service | 1.79.4 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.254 |
