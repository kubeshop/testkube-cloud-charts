...
![Version: 1.63.1](https://img.shields.io/badge/Version-1.63.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.42.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.30.1 |
...
| testkube-cloud-ui.image.tag | string | `"1.9.2"` |  |
