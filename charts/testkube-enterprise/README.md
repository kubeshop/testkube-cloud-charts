...
![Version: 2.126.1](https://img.shields.io/badge/Version-2.126.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.140.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.95.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.54.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.132 |
...
| testkube-cloud-ui.image.tag | string | `"2.8.6"` |  |
