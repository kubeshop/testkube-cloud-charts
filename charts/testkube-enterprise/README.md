...
![Version: 2.319.6](https://img.shields.io/badge/Version-2.319.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.20.1 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.176.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.116.1 |
| file://../testkube-worker-service | testkube-worker-service | 1.79.2 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.240 |
...
| testkube-ai-service.image.tag | string | `"1.15.0"` |  |
...
| testkube-cloud-api.image.tag | string | `"1.15.0"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.15.0"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.15.0"` |  |
...
| testkube-worker-service.image.tag | string | `"1.15.0"` |  |
