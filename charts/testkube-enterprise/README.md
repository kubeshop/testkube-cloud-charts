...
![Version: 1.152.5](https://img.shields.io/badge/Version-1.152.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.82.1 |
...
| testkube-cloud-api.image.tag | string | `"1.10.57"` |  |
