...
![Version: 1.149.11](https://img.shields.io/badge/Version-1.149.11-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.80.3 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.60.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.18 |
...
| testkube-cloud-api.image.tag | string | `"1.10.54"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.3.0"` |  |
