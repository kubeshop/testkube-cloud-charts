...
![Version: 2.98.0](https://img.shields.io/badge/Version-2.98.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.134.0 |
...
| testkube-cloud-ui.image.tag | string | `"2.8.2"` |  |
