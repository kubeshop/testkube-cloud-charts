...
![Version: 1.148.5](https://img.shields.io/badge/Version-1.148.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.80.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.59.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.11 |
...
| testkube-cloud-api.image.tag | string | `"1.10.51"` |  |
