...
![Version: 1.107.1](https://img.shields.io/badge/Version-1.107.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.60.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.49.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.34.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 1.17.96 |
...
| dex.resources | object | `{"limits":{"cpu":"100m","memory":"128Mi"},"requests":{"cpu":"100m","memory":"128Mi"}}` | Set resources requests and limits for Dex Service |
...
| minio.resources | object | `{"limits":{"cpu":2,"memory":"2Gi"},"requests":{"cpu":"500m","memory":"512Mi"}}` | Set resources requests and limits for MinIO |
...
| testkube-cloud-api.image.tag | string | `"1.10.21"` |  |
| testkube-cloud-api.ingress.className | string | `"nginx"` |  |
| testkube-cloud-api.prometheus.enabled | bool | `false` |  |
| testkube-cloud-api.resources | object | `{"limits":{"cpu":1,"memory":"512Mi"},"requests":{"cpu":1,"memory":"512Mi"}}` | Set resources requests and limits for Testkube Api |
