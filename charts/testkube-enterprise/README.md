...
![Version: 1.111.2](https://img.shields.io/badge/Version-1.111.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.62.1 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.50.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 1.17.99 |
...
| testkube-cloud-api.image.tag | string | `"1.10.25"` |  |
