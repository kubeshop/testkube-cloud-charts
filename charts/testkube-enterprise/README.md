...
![Version: 1.201.0](https://img.shields.io/badge/Version-1.201.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.68.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.74 |
...
| testkube-cloud-ui.image.tag | string | `"2.6.4"` |  |
