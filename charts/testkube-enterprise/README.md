...
![Version: 1.153.5](https://img.shields.io/badge/Version-1.153.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.83.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.61.1 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.36 |
...
| testkube-cloud-api.api.migrations.ttlSecondsAfterFinished | int | `0` | TTL for the migration job, defaults to 0 - disable TTL |
...
| testkube-cloud-api.image.tag | string | `"1.10.58"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.4.0"` |  |
