...
| testkube-cloud-api.api.inviteMode | string | `"email"` | Configure which invitation mode to use (for now email is the only supported option): email uses SMTP protocol to send email invites |
