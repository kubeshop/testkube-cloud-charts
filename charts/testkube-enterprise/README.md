...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.12.32 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.12.32 |
...
| testkube-cloud-api.image.tag | string | `"1.3.0-dev-95a814a"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.2.2"` |  |
