...
![Version: 1.55.6](https://img.shields.io/badge/Version-1.55.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.29.5 |
...
| testkube-cloud-ui.image.tag | string | `"1.8.0"` |  |
