...
![Version: 2.148.0](https://img.shields.io/badge/Version-2.148.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-ai-service | testkube-ai-service | 1.0.3 |
| file://../testkube-cloud-api | testkube-cloud-api | 1.144.0 |
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.100.0 |
| file://../testkube-worker-service | testkube-worker-service | 1.56.0 |
...
| testkube-cloud-api.image.tag | string | `"1.11.9"` |  |
...
| testkube-cloud-api.migrationImage.tag | string | `"1.11.9"` |  |
...
| testkube-worker-service.image.tag | string | `"1.11.9"` |  |
