...
![Version: 1.110.0](https://img.shields.io/badge/Version-1.110.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.61.1 |
...
| testkube-cloud-api.image.tag | string | `"1.10.23"` |  |
