...
![Version: 2.55.0](https://img.shields.io/badge/Version-2.55.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| file://../testkube-cloud-ui | testkube-cloud-ui | 1.80.0 |
...
| https://kubeshop.github.io/helm-charts | testkube-agent(testkube) | 2.1.98 |
...
| testkube-cloud-api.image.tag | string | `"1.10.87"` |  |
...
| testkube-cloud-ui.image.tag | string | `"2.7.6"` |  |
