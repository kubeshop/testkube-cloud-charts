...
![Version: 1.66.1](https://img.shields.io/badge/Version-1.66.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
|------------|------|---------|
| file://../testkube-cloud-api | testkube-cloud-api | 1.44.0 |
...
| testkube-cloud-api.image.tag | string | `"1.10.6"` |  |
...
| testkube-cloud-ui.image.tag | string | `"1.9.6"` |  |
