...
![Version: 1.152.4](https://img.shields.io/badge/Version-1.152.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
| testkube-cloud-api.image.tag | string | `"1.10.56"` |  |
