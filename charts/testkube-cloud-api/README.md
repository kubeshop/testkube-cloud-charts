...
![Version: 1.173.0](https://img.shields.io/badge/Version-1.173.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.11.30](https://img.shields.io/badge/AppVersion-1.11.30-informational?style=flat-square)
...
| migrationImage.tag | string | `"1.11.30"` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
