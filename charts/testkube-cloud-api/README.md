...
![Version: 1.170.1](https://img.shields.io/badge/Version-1.170.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.11.29](https://img.shields.io/badge/AppVersion-1.11.29-informational?style=flat-square)
...
| migrationImage.tag | string | `"1.11.29"` |  |
| nameOverride | string | `""` |  |
| nodeSelector | object | `{}` |  |
