...
![Version: 1.35.3](https://img.shields.io/badge/Version-1.35.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.9.17](https://img.shields.io/badge/AppVersion-1.9.17-informational?style=flat-square)
...
| api.agent.storageHost | string | `""` | Agent storage host (can be used if a different storage hostname needs to be used from the agent side) |
