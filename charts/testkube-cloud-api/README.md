...
![Version: 1.176.2](https://img.shields.io/badge/Version-1.176.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.15.1](https://img.shields.io/badge/AppVersion-1.15.1-informational?style=flat-square)
...
| audit.logger.enabled | bool | `false` | Toggle whether to enable logging audit events to console |
| audit.logger.forceIdentifyUsersById | bool | `false` | If enabled, only user ID will be logged, otherwise username/email will also be added as a logger field |
...
| migrationImage.tag | string | `"1.15.1"` |  |
