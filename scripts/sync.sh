...
echo "Updating testkube-cloud-api version in testkube-enterprise Helm chart for demo profile values file to $enterprise_api_app_version"
yq eval -i '.testkube-cloud-api.image.tag = env(enterprise_api_app_version)' "charts/testkube-enterprise/profiles/values.demo.yaml"
...
echo "Updating testkube-cloud-ui version in testkube-enterprise Helm chart for demo profile values file to $enterprise_ui_app_version"
yq eval -i '.testkube-cloud-ui.image.tag = env(enterprise_ui_app_version)' "charts/testkube-enterprise/profiles/values.demo.yaml"
...
echo "Updating testkube-worker-service version in testkube-enterprise Helm chart for demo profile values file to to $enterprise_worker_service_app_version"
yq eval -i '.testkube-worker-service.image.tag = env(enterprise_worker_service_app_version)' "charts/testkube-enterprise/profiles/values.demo.yaml"
